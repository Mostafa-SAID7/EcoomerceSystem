    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
            <div class="mb-3 md:mb-0">
                &copy; <?php echo e(date('Y')); ?> MyBrand. All rights reserved.
            </div>
            <div class="flex items-center space-x-4">
                <img src="<?php echo e(asset('images/payment.png')); ?>" alt="payment" class="h-6">

            </div>
        </div>
    </div>
</footer>
<?php /**PATH D:\Projects\ecommerce-multivendor2\resources\views/partials/footer.blade.php ENDPATH**/ ?>